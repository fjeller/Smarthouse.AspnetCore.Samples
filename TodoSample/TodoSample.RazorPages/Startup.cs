...
using TodoSample.Core.Repositories;
using TodoSample.Core.Repositories.Interfaces;
using TodoSample.Core.Services;
using TodoSample.Core.Services.Interfaces;

namespace TodoSample.RazorPages
{
	public class Startup
	{
		...
		public void ConfigureServices( IServiceCollection services )
		{
			...
			// Add our Repository and the service to the servicecollection of the DI
